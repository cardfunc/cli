...
export class Connection {
	...
	change(properties: { storage: Server.Storage | string | undefined, credentials: Server.Credentials | string | undefined, url: string | undefined }): Promise<Connection | undefined> {
